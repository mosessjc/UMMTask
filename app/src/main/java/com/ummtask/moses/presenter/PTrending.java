...
public class PTrending extends RecyclerView
        .Adapter<PTrending
        .DataObjectHolder> {
    private static ArrayList<Model> mDataset;
    private static PTrending.MyClickListener myClickListener;
    Context context;
    Typeface myTypeface;
...
//            myClickListener.onItemClick(getAdapterPosition(), v);
    ...
    public void setOnItemClickListener(PTrending.MyClickListener myClickListener) {
        this.myClickListener = myClickListener;
    }

    public PTrending(Context context, ArrayList<Model> myDataset) {
    ...
    @Override
    public PTrending.DataObjectHolder onCreateViewHolder(ViewGroup parent,
                                                         int viewType) {
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.custom_childview_layout, parent, false);

        PTrending.DataObjectHolder dataObjectHolder = new PTrending.DataObjectHolder(view);
        return dataObjectHolder;
    }

    @Override
    public void onBindViewHolder(final PTrending.DataObjectHolder holder, final int position) {
