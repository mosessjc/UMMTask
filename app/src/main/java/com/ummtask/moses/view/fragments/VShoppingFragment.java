...
public class VShoppingFragment extends Fragment {
    //RecyclerView
    Unbinder unbinder;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view =  inflater.inflate(R.layout.vshopping_fragment, container, false);
    ...
    public void setUpViews() {
        //RecyclerView
        rvShopping = (RecyclerView) view.findViewById(R.id.rvShopping);
        rvShopping.setHasFixedSize(true);
        mLayoutManager = new LinearLayoutManager(getActivity());
        rvShopping.setLayoutManager(mLayoutManager);

        mAdapter = new Presenter(getActivity(), Data.othersData());
        rvShopping.setAdapter(mAdapter);
    }
